...
public class LargeInteger implements Serializable{
    ...
    //--------------------------------------------------------------------------
    //Wrapper for compare to that allows another LargeInteger to be taken as an
    //argument
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    //Returns 1 if this LargeInteger is larger the byte[] passed to it, -1 if 
    ...
    //--------------------------------------------------------------------------
    //adds a given byte[] array x and the byte[] of this LargeInteger
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    //multiplies this LargeInteger with the byte[] y using the gradeschool 
    //algorithm
    //--------------------------------------------------------------------------
    ...
    public byte[] mod(LargeInteger b){
    ...
    public byte[] GCD(LargeInteger a, LargeInteger b){
            if(equalsZero((a.mod(b.getArray())))){
                return b.getArray();
            }else{
                LargeInteger aModB = new LargeInteger(a.mod(b.getArray()));
                return GCD(b, aModB);
            }
        }
